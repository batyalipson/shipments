 ...
 */
public class GetJobsDataAsyncTask extends AsyncTask<Void,Void,ResultEntity> {

    private static final String URL= StartApplication.START_URL+"/tr-api/?action=jobs&user_id=";
    Context context;
    IResultsInterface iResultsInterface;

    public GetJobsDataAsyncTask(Context context, IResultsInterface iResultsInterface){
